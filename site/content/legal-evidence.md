...
### Rule 902(13): Certified records (Planned)

**Planned.** Rule 902(13) allows self-authentication of records generated by an electronic process or system using a written certification meeting the requirements of Rule 902(11) or (12). WRL is building a certification document generator that will produce a templated declaration attesting to the capture process, the operator's identity, and the specific capture's verification status. This declaration is intended to support a 902(13) foundation when combined with the WACZ bundle. This feature is **planned** and not yet available.
