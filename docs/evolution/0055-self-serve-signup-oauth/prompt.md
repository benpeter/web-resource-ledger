# Phase 0055: Self-Serve Signup (OAuth)

Source: GitHub Issue #103

**Outcome**: Users can sign up for WRL via GitHub OAuth, automatically receiving a tenant and first API key. The web UI provides account management (view, create, revoke keys) behind a session cookie. The existing admin API continues to work for operator-managed tenants.
